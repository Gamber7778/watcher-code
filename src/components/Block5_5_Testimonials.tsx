...
const testimonials: Testimonial[] = [
    ...
    },
    {
        ...
        date: "12 марта 2025",
        rating: 5,
        text: "Трансерфинг читал еще 10 лет назад, но только сейчас понял, как это работает на практике. Живой голос Зеланда в аудио-пакете — это совершенно другой уровень погружения. Рекомендую всем, кто устал от теории.",
        platform: "Проверенная покупка"
    },
    {
        id: 5,
