                        ...
                        <div className="space-y-5 sm:space-y-6">
                            {[
                                ...
                                { 
                                    ...
                                    desc: "Сотни писем каждый день показывают: люди знают теорию, но застревают в практике. Моя задача — помочь вам сместиться на ту линию, где изменения уже происходят. Не объяснить снова, а сместить." 
                                }
                            ].map((item, idx) => (
                                <motion.div
                                    key={idx}
