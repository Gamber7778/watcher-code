        ...
        <div className="relative aspect-video bg-black overflow-hidden group cursor-pointer shadow-[0_0_80px_rgba(0,0,0,0.9)]">
            ...
            {playing && (
                <motion.iframe
                    ...
                    title="Как перестать быть донором чужих маятников"
...
const PAINS = [
    {
        icon: "◎",
        title: "Устали помогать",
        body: "Вы отдаёте последние силы, обслуживая чужие интересы. Помогаете всем — и всё равно чувствуете себя виноватыми.",
    },
    {
        icon: "◎",
        title: "Живу интересами других",
        body: "Ваша собственная жизнь поставлена на паузу. Стоит лишь подумать о себе — накрывает удушливое чувство вины.",
    },
    {
        icon: "◎",
        title: "«Не те» люди рядом",
        body: "Снова и снова в окружении оказываются те, кто берёт, но не отдаёт. Ваша доброта становится их ресурсом.",
    },
    {
        icon: "◎",
        title: "Страх быть «плохим»",
        body: "Вы боитесь осуждения, боитесь отвержения. И потому продолжаете быть «удобными» — ценой собственной энергии.",
    },
];

const PARAGRAPHS = [
    "Ваша жизненная энергия превратилась в лакомый кусок для чужих маятников. Вы отдаёте последние силы, обслуживая чужие интересы — но стоит подумать о себе, как накрывает удушливое чувство вины.",
    "Поймите одну вещь: это чувство вины вам не принадлежит. Это ниточка, за которую вас дёргают марионеточники. Вас приучили быть «удобными», чтобы беспрепятственно качать из вас энергию. Вы боитесь осуждения, боитесь отвержения — и потому ваша жизнь поставлена на паузу.",
    "Чтобы вернуть себя, не нужно ни с кем воевать. Нужно просто провалить маятник. Как только вы сбросите ложную вину и закроете доступ к своей энергии — манипуляторы отвалятся сами. Я передам вам ключи от этой двери.",
];

const BONUSES = [
    {
        icon: "pdf" as const,
        title: "PDF-Инструкция: «Анатомия вины»",
        subtitle: "5 фраз, которые мгновенно проваливают маятник манипулятора",
        body: "Конкретные словесные формулы-амортизаторы, которые позволяют согласиться с нападками манипулятора на формальном уровне — не отдавая энергию и не вступая в конфликт. Практическое оружие (точнее, щит пустоты), которое можно применить уже сегодня вечером.",
        tracks: null,
    },
    {
        icon: "audio" as const,
        title: "Аудио-настройка: «Позиция Смотрителя»",
        subtitle: "Как стать невидимым для чужих проблем · 10–15 минут",
        body: "Это не медитация в классическом понимании. Это техника переключения внимания — как в момент, когда от вас чего-то требуют, «выйти в зрительный зал», осознать себя игроком на сцене и позволить ситуации пройти мимо.",
        tracks: [
            "Сброс чужого давления: выход из роли «удобного»",
            "Переключение в позицию отстранённого Смотрителя",
            "Закрытие энергетического доступа без вины и конфликта",
        ],
    },
    {
        icon: "audio" as const,
        title: "Транс-экскурс: «Очищение от чужой важности»",
        subtitle: "Аудио-практика · глубокое погружение",
        body: "Погружение в состояние, где вы физически и ментально сбрасываете с плеч чужие цели, навязанные долги и обязательства. Мы возвращаем ощущение вашего уникального пути, где вы никому ничего не должны, кроме самого себя.",
        tracks: null,
    },
];
...
const AUDIENCE = [
    {
        quote: "«Устали помогать, устали заботиться — делаю всё против себя»",
    },
    {
        quote: "«Живу интересами других, а когда выбираю себя — возникает дикое чувство вины»",
    },
    {
        quote: "«Вновь и вновь встречаю \u201cне тех\u201d людей»",
    },
];

export default function Exit1Page() {
    return (
        <div className="min-h-screen bg-deep-space text-foreground overflow-x-hidden">
            ...
            <section className="relative flex items-center justify-center px-5 overflow-hidden bg-black">
                ...
                <div className="relative z-10 text-center max-w-3xl mx-auto pt-14 pb-10 sm:py-24">
                    ...
                    >
                        Практическое руководство для тех, кто устал
                    </motion.h1>
                ...
                <div className="max-w-2xl mx-auto">
                    ...
                    >
                        <p className="text-[1.05rem] sm:text-xl md:text-2xl font-cormorant font-light text-foreground/80 leading-[1.55] mb-3">
                            Ваша энергия принадлежит только вам.
                        </p>
                        ...
                        <p className="text-[0.88rem] sm:text-base font-manrope font-extralight text-foreground/50 leading-[1.8]">
                            Чувство вины — это крючок, за который вас держит Система.
                            Освободитесь от него без борьбы и оправданий.
                        </p>
                    </motion.div>
                </div>
            </section>
                ...
                <div className="max-w-2xl mx-auto relative z-10">
                    ...
                    >
                        <p className="text-[0.9rem] sm:text-base font-manrope font-extralight text-foreground/75 leading-[1.85] mb-3">
                            Я подготовил для вас точечный алгоритм по выходу из роли энергетического донора. Это не психология и не мотивация. Это прикладная механика Трансерфинга — как экологично закрыть доступ к своей энергии, не вступая в конфликт и не испытывая вины.
                        </p>
                        <p className="text-[0.9rem] sm:text-base font-manrope font-extralight text-foreground/75 leading-[1.85]">
                            ...
                            Всё необходимое загружено в специальный Telegram-бот.
                        </p>
                    </motion.div>
                    ...
                    >
                        ...
                        <p className="text-[0.88rem] sm:text-base font-manrope font-extralight text-foreground/55 leading-[1.9] mb-4">
                            Вы можете продолжать биться в закрытые двери — отдавая силы тем, кому всегда будет мало. А можете просто проснуться и выйти из этой игры.
                        </p>
                        <p className="text-[0.88rem] sm:text-base font-manrope font-extralight text-foreground/55 leading-[1.9] mb-5">
                            Это не психология уговоров. Это чистая механика управления энергией. Послушайте аудио-настройку «Позиция Смотрителя» — и манипуляторы потеряют к вам интерес сами.
                        </p>
            ...
            <section className="py-12 sm:py-16 px-5 bg-black relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-b from-black via-deep-space/40 to-black pointer-events-none" />

                <div className="max-w-2xl mx-auto relative z-10">
                    <motion.div {...fadeUp(0)} className="text-center mb-8 sm:mb-10">
                        <p className="text-[10px] sm:text-xs tracking-[0.3em] text-foreground/30 uppercase mb-3 font-manrope font-extralight">
                            Портрет аудитории
                        </p>
                        <h2 className="text-xl sm:text-2xl md:text-3xl font-cormorant font-light text-foreground/80 tracking-wide leading-[1.35]">
                            Это для «удобных» и сильных —<br className="hidden sm:block" /> тех, кто привык тащить всё на себе
                        </h2>
                        <div className="w-10 h-px bg-flame/25 mx-auto mt-4" />
                    </motion.div>

                    {/* Характеристики */}
                    <motion.div
                        {...fadeUp(0.1)}
                        className="border border-white/[0.07] bg-white/[0.02] p-6 sm:p-8 mb-6 sm:mb-8"
                    >
                        <ul className="space-y-4">
                            {[
                                "Постоянно помогают другим, даже в ущерб себе",
                                "Испытывают вину, когда пытаются поставить свои интересы на первое место",
                                "Притягивают к себе «не тех людей» — энергетических вампиров, которые пользуются их добротой",
                                "Их душа знает, что так нельзя — но разум скован страхом отвержения",
                            ].map((item, idx) => (
                                <li key={idx} className="flex items-start gap-3">
                                    <span className="text-flame/40 mt-[5px] shrink-0">◎</span>
                                    <span className="text-[0.9rem] sm:text-base font-manrope font-extralight text-foreground/65 leading-[1.75]">
                                        {item}
                                    </span>
                                </li>
                            ))}
                    ...
                    <motion.p
                        {...fadeUp(0.1)}
                        className="text-[10px] sm:text-xs tracking-[0.28em] text-foreground/30 uppercase font-manrope font-extralight mb-4 sm:mb-5 text-center"
                    >
                        Они говорят именно так:
                    </motion.p>
                    ...
                    <div className="space-y-3 sm:space-y-4 mb-10 sm:mb-12">
                        {AUDIENCE.map((item, idx) => (
                            <motion.div
                                ...
                                className="px-5 py-4 sm:px-6 sm:py-5 bg-white/[0.025] border border-white/[0.06] border-l-[2px] border-l-flame/30"
                            >
                                <p className="text-[0.9rem] sm:text-base font-cormorant font-light text-foreground/65 leading-[1.6] italic">
                                    {item.quote}
                                </p>
                            </motion.div>
                        ))}
                    ...
                    <motion.div {...fadeUp(0.15)} className="text-center mb-6 sm:mb-8">
                        <p className="text-[10px] sm:text-xs tracking-[0.3em] text-foreground/30 uppercase mb-3 font-manrope font-extralight">
                            Суть предложения
                        </p>
                        <div className="border border-flame/10 bg-white/[0.015] p-6 sm:p-8 text-left space-y-5">
                            <div>
                                <p className="text-[10px] tracking-[0.25em] text-flame/50 uppercase font-manrope font-extralight mb-2">Подход</p>
                                <p className="text-[0.9rem] sm:text-base font-manrope font-extralight text-foreground/65 leading-[1.8]">
                                    Научить экологично выстраивать личные границы и отключаться от деструктивных маятников — людей-потребителей — без чувства вины.
                                </p>
                            </div>
                            <div className="w-full h-px bg-white/[0.06]" />
                            <div>
                                <p className="text-[10px] tracking-[0.25em] text-flame/50 uppercase font-manrope font-extralight mb-2">Оффер</p>
                                <p className="text-[0.9rem] sm:text-base font-cormorant font-light text-foreground/80 leading-[1.7]">
                                    Практикум «Как выбрать себя без чувства вины и вернуть свою энергию» — или — «Энергетическая защита: как перестать быть донором для окружающих»
                                </p>
                            </div>
                            <div className="w-full h-px bg-white/[0.06]" />
                            <div>
                                <p className="text-[10px] tracking-[0.25em] text-flame/50 uppercase font-manrope font-extralight mb-2">Лид-магнит</p>
                                <p className="text-[0.9rem] sm:text-base font-cormorant font-light text-foreground/80 leading-[1.7]">
                                    «Тест: являетесь ли вы энергетическим донором для своего окружения?»
                                </p>
                            </div>
                        </div>
                    </motion.div>
