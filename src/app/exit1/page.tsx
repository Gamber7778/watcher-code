...
const PAINS = [
    {
        icon: "◎",
        title: "Устала помогать",
        body: "Вы отдаёте последние силы, обслуживая чужие интересы. Помогаете всем — и всё равно чувствуете себя виноватой.",
    },
    {
        icon: "◎",
    ...
    },
    {
        ...
        body: "Снова и снова в вашем окружении оказываются те, кто берёт, но не даёт. Вы притягиваете тех, кто питается вашей добротой.",
    },
    {
        icon: "◎",
        title: "Страх быть «плохой»",
        body: "Вы боитесь отвержения, боитесь осуждения. И потому продолжаете быть «удобной» — ценой собственной энергии.",
    },
];

const PARAGRAPHS = [
    "Ваша жизненная энергия превратилась в лакомый кусок для чужих маятников. Вы отдаёте последние силы, обслуживая чужие интересы, но стоит вам лишь подумать о себе, как вас накрывает удушливое чувство вины.",
    "Поймите одну вещь: это чувство вины вам не принадлежит. Это ниточка, за которую вас дёргают марионеточники. Вас приучили быть «удобным», чтобы беспрепятственно качать из вас энергию. Вы боитесь быть плохой, боитесь отвержения, и потому ваша собственная жизнь поставлена на паузу. Ваша душа буквально кричит, но разум скован страхом.",
    "Чтобы вернуть себе себя, не нужно ни с кем воевать или что-то доказывать. Нужно просто провалить маятник. Как только вы сбросите эту ложную вину и экологично закроете доступ к своей энергии, манипуляторы отвалятся сами собой. Ваша реальность изменится. Я передам вам ключи от этой двери.",
];
...
const AUDIENCE = [
    {
        quote: "«Устала помогать, устала заботиться, делаю против себя»",
    },
    {
                ...
                <div className="max-w-2xl mx-auto relative z-10">
                    ...
                    >
                        <p className="text-xl sm:text-2xl md:text-[1.7rem] font-cormorant font-light text-foreground/70 leading-[1.5] italic mb-2">
                            Манипуляторы не отваливаются от силы.
                        </p>
                        <p className="text-xl sm:text-2xl md:text-[1.7rem] font-cormorant font-light text-flame leading-[1.5]">
                            Они отваливаются от пустоты —<br className="hidden sm:block" /> когда вы перестаёте кормить их виной.
                        </p>
                    </motion.div>
