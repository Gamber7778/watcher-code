                ...
                <div className="max-w-2xl mx-auto relative z-10">
                    <motion.div {...fadeUp(0)} className="text-center mb-8 sm:mb-10">
                        ...
                        <h2 className="text-xl sm:text-2xl md:text-3xl font-cormorant font-light text-foreground/80 tracking-wide leading-[1.35]">
                            Те, кого накрывает страх за будущее
                        </h2>
                    ...
                    >
                        <ul className="space-y-4">
                            {[
                                "Живут в состоянии фоновой тревоги — кризис, война, нестабильность как постоянный фон жизни",
                                "Зависимы от новостной ленты: знают, что это вредно, но не могут остановиться",
                                "Чувствуют полную потерю контроля над внешними обстоятельствами",
                                "Ищут не мотивацию и не советы «думай позитивно» — ищут реальный механизм защиты",
                            ].map((item, idx) => (
                    ...
                    <div className="space-y-3 sm:space-y-4 mb-10 sm:mb-12">
                        {[
                            "«Я понимаю, что надо успокоиться, но не могу — каждый день что-то новое»",
                            "«Читаю новости по 3 часа в день и ненавижу себя за это»",
                            "«Страшно не то, что происходит — страшно, что я не контролирую ничего»",
                        ].map((quote, idx) => (
                            <motion.div
                                key={idx}
                        ...
                        <div className="border border-flame/10 bg-white/[0.015] p-6 sm:p-8 text-left space-y-5">
                            <div>
                                ...
                                <p className="text-[0.9rem] sm:text-base font-manrope font-extralight text-foreground/65 leading-[1.8]">
                                    Не «думай позитивно» и не «отключись от новостей». Научить становиться энергетически невидимым для деструктивных маятников — без борьбы, без отрицания реальности.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-[0.9rem] sm:text-base font-cormorant font-light text-foreground/80 leading-[1.7]">
                                    «Энергетический щит: как сохранить свой мир в безопасности, когда внешний мир сходит с ума»
                                </p>
                            </div>
                            <div className="w-full h-px bg-white/[0.06]" />
                            <div>
                                ...
                                <p className="text-[0.9rem] sm:text-base font-cormorant font-light text-foreground/80 leading-[1.7]">
                                    «Тест: насколько глубоко вас затянул маятник кризиса?»
                                </p>
                            </div>
                        </div>
                    </motion.div>
